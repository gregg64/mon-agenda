        ...
        <div className="filtre-barre">
            ...
            <div className="filtre-ligne filtre-ligne--filtres">
                <div className="filtre-groupe">
                    ...
                    <select className="filtre-select" value={filtreCategorie} onChange={e => onCategorie(e.target.value)}>
                        {categories.map(c => (
                ...
                <div className="filtre-groupe">
                    ...
                    <select className="filtre-select" value={filtrePriorite} onChange={e => onPriorite(e.target.value)}>
                        {priorites.map(p => (
